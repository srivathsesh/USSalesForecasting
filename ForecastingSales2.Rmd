...
The below tables show the performance of all models and their sensitivity to 2015 data inclusion in the training set. Composite model lets us dampen the forecast at a future time and then ramp up the forecast gives this model a better usability.
